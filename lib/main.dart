...
void main() async {
  ...
  database = await openDatabase(
    ...
    onCreate: (Database db, int version) async {
      ...
      await db.execute(
          'CREATE TABLE IF NOT EXISTS "Parties" ("_id"	INTEGER PRIMARY KEY AUTOINCREMENT,"acno"	integer,"dsc"	varchar(50),"Address"	TEXT,"Type"	varchar(1), "Mobile"	varchar(15), "Phone"	varchar(15),     "AreaCd"	integer, "Balance"	float,      "EnabDisab"	varchar(1));');
      await db.execute(
