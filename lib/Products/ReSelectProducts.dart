  ...
  Future<List<Product>> fetchItems(int offset, int limit) async {
    ...
    for (var product in products) {
      Product p = Product(product['pcode'] ?? "", product['name1'],
          double.parse("${product['rp']}"), 0, 0, "${product['_id']}",int.parse("${product['balance']}"));
      final index = selectedProducts
          .indexWhere((element) => element.sku == "${product['pcode']}");
      if (index >= 0) {
                  ...
                  onPressed: () async{
                    if (getSelectedItem().isNotEmpty) {
                      ...
                      MyData md = MyData(
                          ...
                          "0",
                          "0",
                          widget.myData.customer,
                          new Shop("", "", "", '', '', "-1"),
                          _formatDate(DateTime.now()));
                      md.willShowPhones = false;
                     await UpdateInvoice(widget.myData.time, selectedProducts);
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                          "Customer name: ${widget.myData.customer.name}"),
                                    ),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text("Sector: ${widget.myData.customer.phone}"),
                                        Text("Area: ${widget.myData.customer.email}"),
                                                    ...
                                                    children: [
                                                        ...
                                                        children: [
                                                          Expanded(
                                                            child: Text(_searchResult[index]
                                                                .productName+" "+_searchResult[index]
                                                                .sku,style: TextStyle(fontSize: 15),),
                                                          ),
                                                          SizedBox(width: 6,),
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                            ...
                                                            children: [
                                                              ...
                                                              Container(
                                                                child: Padding(
                                                                  ...
                                                                  child: Text('${_searchResult[index].price}',style: TextStyle(fontSize: 13),),
                                                                ),
                                                              ),
                                                            ],
                                                          ),
                                                          Row(
                                                            children: [
                                                              const Text('Disc:',style: TextStyle(fontSize: 13),),
                                                              Container(
                                                                child: Padding(
                                                                  padding: const EdgeInsets.symmetric(
                                                                      horizontal: 12.0, vertical: 4),
                                                                  child:
                                                                  Text('${_searchResult[index].discount}',style: TextStyle(fontSize: 13),),
                                                                ),
                                                          ...
                                                          Row(
                                                            children: [
                                                              const Text('Bns:',style: TextStyle(fontSize: 13),),
                                                              Container(
                                                                child: Padding(
                                                                  padding: const EdgeInsets.symmetric(
                                                                      horizontal: 12.0, vertical: 4),
                                                                  child:
                                                                  Text('${_searchResult[index].bonus}',style: TextStyle(fontSize: 13),),
                                                                ),
                                                              ...
                                                              Container(
                                                                child: Padding(
                                                                  padding: const EdgeInsets.symmetric(
                                                                      horizontal: 12.0, vertical: 4),
                                                                  child:
                                                                  Text('${_searchResult[index].quantity}',style: TextStyle(fontSize: 13),),
                                                                ),
                                                        ...
                                                        children: [
                                                          Expanded(
                                                            child: Text(items[index]
                                                                ...
                                                                .sku + '(${items[index].balance})',style: TextStyle(fontSize: 13,
                                                                fontWeight: FontWeight.bold)),
                                                          ),
                                                        ],
                                                      ),
                                                            ...
                                                            children: [
                                                              ...
                                                              Container(
                                                                child: Padding(
                                                                  padding: const EdgeInsets.symmetric(
                                                                      horizontal: 12.0, vertical: 4),
                                                                  child: Text('${items[index].price}',style: TextStyle(fontSize: 13),),
                                                                ),
                                                              ...
                                                              Container(
                                                                child: Padding(
                                                                  padding: const EdgeInsets.symmetric(
                                                                      horizontal: 12.0, vertical: 4),
                                                                  child:
                                                                  Text('${items[index].discount}',style: TextStyle(fontSize: 13),),
                                                                ),
                                                              ...
                                                              Container(
                                                                child: Padding(
                                                                  padding: const EdgeInsets.symmetric(
                                                                      horizontal: 12.0, vertical: 4),
                                                                  child:
                                                                  Text('${items[index].bonus}',style: TextStyle(fontSize: 13),),
                                                                ),
                                                              ...
                                                              Container(
                                                                child: Padding(
                                                                  padding: const EdgeInsets.symmetric(
                                                                      horizontal: 12.0, vertical: 4),
                                                                  child:
                                                                  Text('${items[index].quantity}',style: TextStyle(fontSize: 13),),
                                                                ),
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () async {
                        setState(() {
                          ...
                          if (productIndex != -1) {
                            items[productIndex].selected = false;
                            selectedProducts.removeWhere((element) => items[productIndex].id==element.id);
                            totalPrice=Product.getTotal(selectedProducts);
                            print("toal $totalPrice");
                          }
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: Text(
                          selectedProducts[index].productName+"        "+selectedProducts[index].sku + '(${selectedProducts[index].balance})',
